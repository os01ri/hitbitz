      ...
      child: BlocListener<RoadmapCubit, RoadmapState>(
        ...
        child: Scaffold(
          appBar: AppBar(
            ...
            actions: [
              IconButton(
                onPressed: () => _cubit.roadMapToggleBookmark(RoadMapToggleBookmarkParams(roadmapId: widget.roadMap.id!)),
                icon: Icon(
          ...
          body: Stack(
            ...
            children: [
              SizedBox(
                ...
                child: (widget.roadMap.media?.mediaUrl != null)
                    ? NetworkImageWidget(
                        url: widget.roadMap.media!.mediaUrl!,
                        hash: widget.roadMap.media!.hash,
                        width: context.width,
                        height: context.height * .3,
