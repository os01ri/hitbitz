...
class RemoteFriendsDataSource {
  ...
  Future<BaseResponse<List<UserProfileModel>>> getUsers({required ParamsMap params}) async {
  ...
  Future<BaseResponse<UserProfileModel>> showUser({required int id, required ParamsMap params}) async {
  ...
  Future<BaseResponse<List<UserProfileModel>>> getFriends({required ParamsMap params}) async {
  ...
  Future<BaseResponse<List<UserProfileModel>>> getFriendRequests({required ParamsMap params}) async {
