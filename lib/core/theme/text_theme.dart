...
const textTheme = TextTheme(
  ...
  labelLarge: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, overflow: TextOverflow.ellipsis),
  labelMedium: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, overflow: TextOverflow.ellipsis),
  labelSmall: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, overflow: TextOverflow.ellipsis),
);
