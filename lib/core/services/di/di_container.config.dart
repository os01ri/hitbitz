...
import '../../../features/auth/domain/usecases/reset_password_usecase.dart'
    as _i26;
import '../../../features/auth/domain/usecases/sign_in_usecase.dart' as _i27;
...
import '../../../features/challenge/presentation/cubit/challenge_cubit.dart'
    as _i66;
import '../../../features/cv/data/datasources/cv_datasource.dart' as _i8;
...
import '../../../features/quiz/domain/usecases/get_quizzes_usecase.dart'
    as _i69;
import '../../../features/quiz/domain/usecases/show_quiz_usecase.dart' as _i71;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i4.RemoteChallengeDataSource>(
      () => const _i4.RemoteChallengeDataSource());
  gh.factory<_i5.RemoteQuizDataSource>(() => const _i5.RemoteQuizDataSource());
  gh.factory<_i6.RemoteProfileDataSource>(
      () => const _i6.RemoteProfileDataSource());
  gh.factory<_i7.RemoteNotificationsDataSource>(
      () => const _i7.RemoteNotificationsDataSource());
  gh.factory<_i8.RemoteCvDatasource>(() => _i8.RemoteCvDatasource());
  gh.factory<_i9.RemoteAuthDataSource>(() => const _i9.RemoteAuthDataSource());
  gh.factory<_i10.RemoteHomeDataSource>(
      () => const _i10.RemoteHomeDataSource());
  gh.factory<_i11.RemoteFriendsDataSource>(
      () => const _i11.RemoteFriendsDataSource());
  gh.factory<_i12.RemoteRoadMapDataSource>(
      () => const _i12.RemoteRoadMapDataSource());
  gh.lazySingleton<_i13.ProfileRepository>(() => _i14.ProfileRepositoryImpl(
      remoteDataSource: gh<_i6.RemoteProfileDataSource>()));
  gh.factory<_i15.CvRepo>(
      () => _i16.CvRepoImpl(datasource: gh<_i8.RemoteCvDatasource>()));
  gh.lazySingleton<_i17.ChallengeRepository>(() => _i18.ChallengeRepositoryImpl(
      remoteDataSource: gh<_i4.RemoteChallengeDataSource>()));
  gh.lazySingleton<_i19.AuthRepository>(() => _i20.AuthRepositoryImpl(
      remoteDataSource: gh<_i9.RemoteAuthDataSource>()));
  gh.lazySingleton<_i21.FriendsRepository>(() => _i22.FriendsRepositoryImpl(
      remoteDataSource: gh<_i11.RemoteFriendsDataSource>()));
  ...
  gh.factory<_i25.ForgetPasswordUsecase>(
      () => _i25.ForgetPasswordUsecase(repository: gh<_i19.AuthRepository>()));
  gh.factory<_i26.ResetPasswordUsecase>(
      () => _i26.ResetPasswordUsecase(repository: gh<_i19.AuthRepository>()));
  gh.factory<_i27.SignInUsecase>(
      () => _i27.SignInUsecase(repository: gh<_i19.AuthRepository>()));
  gh.factory<_i28.LoginUsecase>(
      () => _i28.LoginUsecase(repository: gh<_i19.AuthRepository>()));
  gh.lazySingleton<_i29.NotificationsRepository>(() =>
      _i30.NotificationsRepositoryImpl(
          remoteDataSource: gh<_i7.RemoteNotificationsDataSource>()));
  ...
  gh.lazySingleton<_i33.RoadMapRepository>(() => _i34.RoadMapRepositoryImpl(
      remoteDataSource: gh<_i12.RemoteRoadMapDataSource>()));
  ...
  gh.lazySingleton<_i42.HomeRepository>(() => _i43.HomeRepositoryImpl(
      remoteDataSource: gh<_i10.RemoteHomeDataSource>()));
  ...
  gh.lazySingleton<_i50.AuthCubit>(() => _i50.AuthCubit(
        ...
        signInUsecase: gh<_i27.SignInUsecase>(),
  ...
  gh.factory<_i55.CreateCustomQuizUsecase>(() =>
      _i55.CreateCustomQuizUsecase(repository: gh<_i33.RoadMapRepository>()));
  gh.factory<_i56.ShowRoadMapUsecase>(
      () => _i56.ShowRoadMapUsecase(repository: gh<_i33.RoadMapRepository>()));
  gh.factory<_i57.RedeemCertificateUsecase>(() =>
      _i57.RedeemCertificateUsecase(repository: gh<_i33.RoadMapRepository>()));
  gh.factory<_i58.RoadMapToggleBookmarkUsecase>(() =>
      _i58.RoadMapToggleBookmarkUsecase(
          repository: gh<_i33.RoadMapRepository>()));
  gh.factory<_i59.GetSavedRoadmapsUsecase>(() =>
      _i59.GetSavedRoadmapsUsecase(repository: gh<_i33.RoadMapRepository>()));
  gh.factory<_i60.GetStepsUsecase>(
      () => _i60.GetStepsUsecase(repository: gh<_i33.RoadMapRepository>()));
  gh.factory<_i61.StartRoadMapUsecase>(
      () => _i61.StartRoadMapUsecase(repository: gh<_i33.RoadMapRepository>()));
  ...
  gh.factory<_i70.CompleteCustomQuizUsecase>(() =>
      _i70.CompleteCustomQuizUsecase(repository: gh<_i44.QuizRepository>()));
  gh.factory<_i71.ShowQuizUsecase>(
      () => _i71.ShowQuizUsecase(repository: gh<_i44.QuizRepository>()));
  gh.lazySingleton<_i72.QuizCubit>(() => _i72.QuizCubit(
        getQuizzesUsecase: gh<_i69.GetQuizzesUsecase>(),
        showQuizUsecase: gh<_i71.ShowQuizUsecase>(),
        completeQuizUsecase: gh<_i68.CompleteQuizUsecase>(),
        completeCustomQuizUsecase: gh<_i70.CompleteCustomQuizUsecase>(),
      ));
  ...
  gh.lazySingleton<_i74.RoadmapCubit>(() => _i74.RoadmapCubit(
        showRoadMapUsecase: gh<_i56.ShowRoadMapUsecase>(),
        startRoadMapUsecase: gh<_i61.StartRoadMapUsecase>(),
        getStepsUsecase: gh<_i60.GetStepsUsecase>(),
        roadMapToggleBookmarkUsecase: gh<_i58.RoadMapToggleBookmarkUsecase>(),
        getSavedRoadmapsUsecase: gh<_i59.GetSavedRoadmapsUsecase>(),
        getRoadMapsUsecase: gh<_i64.GetRoadMapsUsecase>(),
        createCustomQuizUsecase: gh<_i55.CreateCustomQuizUsecase>(),
        redeemCertificateUsecase: gh<_i57.RedeemCertificateUsecase>(),
      ));
